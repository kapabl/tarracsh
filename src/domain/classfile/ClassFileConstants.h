/**
 *  copied from openjdk
 *  https://sourcegraph.com/github.com/kapabl/jdk/-/blob/src/hotspot/share/include/jvm_constants.h
 *  ~kapa
 *
 */
...
enum MethodHandleSubtypes: unsigned char {
    JVM_REF_getField = 1,
    JVM_REF_getStatic = 2,
    JVM_REF_putField = 3,
    JVM_REF_putStatic = 4,
...
enum SignatureTypes: unsigned char {
    JVM_SIGNATURE_SLASH = '/',
    JVM_SIGNATURE_DOT = '.',
    ...
    JVM_SIGNATURE_CLASS2 = 'c',
    JVM_SIGNATURE_ANNOTATION = '@',
    JVM_SIGNATURE_ENUM2 = 'e',
    JVM_SIGNATURE_STRING = 's',
};
