...
void MethodRefs::defineColumns() {
    ...
    DECLARE_FOREIGN_COLUMN_PROP(MethodRefRow, ownerClass, StorageType::Ref, DisplayAs::AsRef, _classfiles->getName().c_str(), "classname");
    ...
    DECLARE_FOREIGN_COLUMN_PROP(MethodRefRow, targetClass, StorageType::Ref, DisplayAs::AsRef, _classfiles->getName().c_str(), "classname");
    DECLARE_FOREIGN_COLUMN_PROP(MethodRefRow, targetMethod, StorageType::Ref, DisplayAs::AsRef, _methods->getName().c_str(), "name");
}
