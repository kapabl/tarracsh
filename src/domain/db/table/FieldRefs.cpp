...
void FieldRefs::defineColumns() {
    ...
    DECLARE_FOREIGN_COLUMN_PROP(FieldRefRow, ownerClass, StorageType::Ref, DisplayAs::AsRef, _classfiles->getName().c_str(), "classname");
    ...
    DECLARE_FOREIGN_COLUMN_PROP(FieldRefRow, targetClass, StorageType::Ref, DisplayAs::AsRef, _classfiles->getName().c_str(), "classname");
    DECLARE_FOREIGN_COLUMN_PROP(FieldRefRow, targetField, StorageType::Ref, DisplayAs::AsRef, _fields->getName().c_str(), "name");
